...
/**
 * UFC Website Accessibility Testing Suite
...
program
  .option('-u, --url <url>', 'Base URL to test', 'https://www.ufc.br')
  .option('-h, --headless', 'Run in headless mode', false)
  .option('-r, --report', 'Generate detailed HTML report', false)
  .option('-o, --output <dir>', 'Output directory for results', './ufc-accessibility-results')
...
const TEST_CONFIG = {
  ...
  pages: [
    ...
    { name: 'Education', path: '/ensino' },
    { name: 'Research', path: '/pesquisa' },
    { name: 'Admissions', path: '/editais-e-concursos/graduacao' }
  ],
                ...
                <div class="page-card">
                    ...
                    <div style="padding: 20px;">
                        ...
                        ` : (() => {
                            ...
                            if (violations.length === 0 && violationCount > 0) {
                                return `
                                    <div style="color: #e74c3c; padding: 15px; background: #fdf2f2; border-radius: 5px;">
                                        ⚠️ ${violationCount} violation(s) detected, but details are missing from the data.
                                    </div>
                                `;
                            }
